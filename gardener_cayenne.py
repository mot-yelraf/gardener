...
# module for Cayenne client interface
import cayenne.client

#Cayenne client setup - you will need your own username, password, clientid, logging
MQTT_USERNAME = "791abc40-5e97-11eb-b767-3f1a8f1211ba"
MQTT_PASSWORD = "d3c274038c9da86fc8a69bb59603d9622004a908"
MQTT_CLIENT_ID = "91da8630-7dcc-11eb-b767-3f1a8f1211ba"
...
def main():
  ...
  while True:
    ...
    if (time.time() > timestamp + 10):
        ...
        client.hectoPascalWrite(3, pressure)
        timestamp = time.time()
        i = i+1
